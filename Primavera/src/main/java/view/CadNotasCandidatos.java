...
public class CadNotasCandidatos extends JFrame{
	public CadNotasCandidatos() 
	{
		...
		DefaultListModel Candidatos = new DefaultListModel();
		JList list = new JList(Candidatos);
		list.setSelectionMode(ListSelectionModel.SINGLE_SELECTION);
		list.setLayoutOrientation(JList.VERTICAL);
		Candidatos.add(0,"XXXXXXXXX XXXXXXXXX XXXXXXX");
		Candidatos.add(1,"YYYYYYYYYYYYYYY YY YYYYYYYY");
		Candidatos.add(2,"XXXXXXXXX XXXXXXXXX XXXXXXX");
		Candidatos.add(3,"zzzzzz XXXXXXXXX zz");
		Candidatos.add(4,"xxx vvvvvvvvvvvv XXXXXXX");
		Candidatos.add(5,"XXXXvXXXXX XXXXXXXXX XXXXXXX");
		Candidatos.add(6,"vvvvvvvvvvvvvv XXXXXXXXX XXXXXXX");
		Candidatos.add(7,"XXXXXXXXX XXXXXXXXX XXXXXXX");
		Candidatos.add(8,"XXXXXXXXX XXXXXXXXX XXXXXXX");
		Candidatos.add(9,"XXXXXXXXX XXXXXXXXX XXXXXXX");
		Candidatos.add(10,"XXXXXXXXX XXXXXXXXX XXXXXXX");
		Candidatos.add(11,"XXXXXXXXX XXXXXXXXX XXXXXXX");
		Candidatos.add(12,"XXXXXXXXX XXXXXXXXX XXXXXXX");
		Candidatos.add(13,"XXXXXXXXX XXXXXXXXX XXXXXXX");
		Candidatos.add(14,"XXXXXXXXX XXXXXXXXX XXXXXXX");
		Candidatos.add(15,"XXXXXXXXX XXXXXXXXX XXXXXXX");
		Candidatos.add(16,"XXXXXXXXX XXXXXXXXX XXXXXXX");
		Candidatos.add(17,"YYYYYYYYYYYYYYY YY YYYYYYYY");
		Candidatos.add(18,"XXXXXXXXX XXXXXXXXX XXXXXXX");
		Candidatos.add(19,"zzzzzz XXXXXXXXX zz");
		Candidatos.add(20,"xxx vvvvvvvvvvvv XXXXXXX");
		Candidatos.add(21,"XXXXvXXXXX XXXXXXXXX XXXXXXX");
		Candidatos.add(22,"vvvvvvvvvvvvvv XXXXXXXXX XXXXXXX");
		Candidatos.add(23,"XXXXXXXXX XXXXXXXXX XXXXXXX");
		Candidatos.add(24,"XXXXXXXXX XXXXXXXXX XXXXXXX");
		Candidatos.add(25,"XXXXXXXXX XXXXXXXXX XXXXXXX");
		Candidatos.add(26,"XXXXXXXXX XXXXXXXXX XXXXXXX");
		Candidatos.add(27,"XXXXXXXXX XXXXXXXXX XXXXXXX");
		Candidatos.add(28,"XXXXXXXXX XXXXXXXXX XXXXXXX");
		Candidatos.add(29,"XXXXXXXXX XXXXXXXXX XXXXXXX");
		Candidatos.add(30,"XXXXXXXXX XXXXXXXXX XXXXXXX");
		Candidatos.add(31,"ultimo XXXXXXXXX XXXXXXX");
