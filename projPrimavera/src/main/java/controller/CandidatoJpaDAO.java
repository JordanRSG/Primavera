...
public class CandidatoJpaDAO {
         ...
         @SuppressWarnings("unchecked")
         public List<Candidatos> findSexM() {
                   return entityManager.createQuery("FROM Candidatos WHERE Sexo = '1'").getResultList();
         }
         
         @SuppressWarnings("unchecked")
         public List<Candidatos> findSexF() { 
                  return entityManager.createQuery("FROM Candidatos WHERE Sexo = '0'").getResultList();
         }
